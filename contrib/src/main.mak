...
PKGS_DEPS := $(sort $(foreach p,$(PKGS_ENABLE),$(DEPS_$(p))))

# Result to be build
PKGS := $(sort $(PKGS_ENABLE) $(PKGS_DEPS))
...
list:
	@echo INFO: PKGS_ALL All packages:
	@echo '  $(PKGS_ALL)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_FOUND Distribution-provided packages:
	@echo '  $(PKGS_FOUND)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_AUTOMATIC Automatically selected packages:
	@echo '  $(PKGS_AUTOMATIC)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_DISABLE Manually deselected packages:
	@echo '  $(PKGS_DISABLE)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_MANUAL Manually selected packages:
	@echo '  $(PKGS_MANUAL)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_ENABLE Manually selected packages:
	@echo '  $(PKGS_ENABLE)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS_DEPS Depended-on packages:
	@echo '  $(PKGS_DEPS)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
	@echo INFO: PKGS To-be-built packages:
	@echo '  $(PKGS)' | tr " " "\n" | sort | tr "\n" " " |fmt
	@echo ""
